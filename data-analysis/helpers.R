...
{
  label_lookup      <- data.frame(condition=c('twopointl.pc.accuracy', 'twopointl.tv.accuracy', 'twopointl.pc.accuracy - twopointl.tv.accuracy', 
                                              'threepointl.pc.accuracy', 'threepointl.tv.accuracy', 'threepointl.pc.accuracy - threepointl.tv.accuracy', 
                                              'nonlinear.pc.accuracy', 'nonlinear.tv.accuracy', 'nonlinear.pc.accuracy - nonlinear.tv.accuracy', 
                                              'twopointl.pc.accuracy_low', 'twopointl.tv.accuracy_low', 'twopointl.pc.accuracy_low - twopointl.tv.accuracy_low', 
                                              'twopointl.pc.accuracy_medium', 'twopointl.tv.accuracy_medium', 'twopointl.pc.accuracy_medium - twopointl.tv.accuracy_medium', 
                                              'twopointl.pc.accuracy_high', 'twopointl.tv.accuracy_high', 'twopointl.pc.accuracy_high - twopointl.tv.accuracy_high', 
                                              'threepointl.pc.accuracy_low', 'threepointl.tv.accuracy_low', 'threepointl.pc.accuracy_low - threepointl.tv.accuracy_low', 
                                              'threepointl.pc.accuracy_medium', 'threepointl.tv.accuracy_medium', 'threepointl.pc.accuracy_medium - threepointl.tv.accuracy_medium', 
                                              'threepointl.pc.accuracy_high', 'threepointl.tv.accuracy_high', 'threepointl.pc.accuracy_high - threepointl.tv.accuracy_high', 
                                              'nonlinear.pc.accuracy_low', 'nonlinear.tv.accuracy_low', 'nonlinear.pc.accuracy_low - nonlinear.tv.accuracy_low', 
                                              'nonlinear.pc.accuracy_medium', 'nonlinear.tv.accuracy_medium', 'nonlinear.pc.accuracy_medium - nonlinear.tv.accuracy_medium', 
                                              'nonlinear.pc.accuracy_high', 'nonlinear.tv.accuracy_high', 'nonlinear.pc.accuracy_high - nonlinear.tv.accuracy_high', 
                                              'twopointl.accuracy', 'threepointl.accuracy', 'nonlinear.accuracy', 
                                              'twopointl.accuracy_low', 'threepointl.accuracy_low', 'nonlinear.accuracy_low', 
                                              'twopointl.accuracy_medium', 'threepointl.accuracy_medium', 'nonlinear.accuracy_medium', 
                                              'twopointl.accuracy_high', 'threepointl.accuracy_high', 'nonlinear.accuracy_high', 
                                              'twopointl.pc.satisfaction', 'twopointl.tv.satisfaction', 'twopointl.pc.satisfaction - twopointl.tv.satisfaction', 
                                              'threepointl.pc.satisfaction', 'threepointl.tv.satisfaction', 'threepointl.pc.satisfaction - threepointl.tv.satisfaction', 
                                              'nonlinear.pc.satisfaction', 'nonlinear.tv.satisfaction', 'nonlinear.pc.satisfaction - nonlinear.tv.satisfaction', 
                                              'twopointl.pc.confidence', 'twopointl.tv.confidence', 'twopointl.pc.confidence - twopointl.tv.confidence', 
                                              'threepointl.pc.confidence', 'threepointl.tv.confidence', 'threepointl.pc.confidence - threepointl.tv.confidence', 
                                              'nonlinear.pc.confidence', 'nonlinear.tv.confidence', 'nonlinear.pc.confidence - nonlinear.tv.confidence', 
                                              'twopointl.pc.easiness', 'twopointl.tv.easiness', 'twopointl.pc.easiness - twopointl.tv.easiness', 
                                              'threepointl.pc.easiness', 'threepointl.tv.easiness', 'threepointl.pc.easiness - threepointl.tv.easiness', 
                                              'nonlinear.pc.easiness', 'nonlinear.tv.easiness', 'nonlinear.pc.easiness - nonlinear.tv.easiness', 
                                              'twopointl.pc.attachment', 'twopointl.tv.attachment', 'twopointl.pc.attachment - twopointl.tv.attachment', 
                                              'threepointl.pc.attachment', 'threepointl.tv.attachment', 'threepointl.pc.attachment - threepointl.tv.attachment', 
                                              'nonlinear.pc.attachment', 'nonlinear.tv.attachment', 'nonlinear.pc.attachment - nonlinear.tv.attachment', 
                                              'twopointl.pc.preference', 'twopointl.tv.preference', 'twopointl.pc.preference - twopointl.tv.preference', 
                                              'threepointl.pc.preference', 'threepointl.tv.preference', 'threepointl.pc.preference - threepointl.tv.preference', 
                                              'nonlinear.pc.preference', 'nonlinear.tv.preference', 'nonlinear.pc.preference - nonlinear.tv.preference'), 
                                  label=c('PC', 'TV', 'PC-TV', 
                                          'PC', 'TV', 'PC-TV', 
                                          'PC', 'TV', 'PC-TV', 
                                          'PC (low)', 'TV (low)', 'PC-TV (low)', 
                                          'PC (medium)', 'TV (medium)', 'PC-TV (med.)', 
                                          'PC (high)', 'TV (high)', 'PC-TV (high)', 
                                          'PC (low)', 'TV (low)', 'PC-TV (low)', 
                                          'PC (medium)', 'TV (medium)', 'PC-TV (med.)', 
                                          'PC (high)', 'TV (high)', 'PC-TV (high)', 
                                          'PC (low)', 'TV (low)', 'PC-TV (low)', 
...
{
  label_lookup      <- data.frame(group=c('OD', 'RF', 'ASF'), label=c('low', 'medium', 'high'))
  set.seed(0) # make deterministic
  accuracyCI        <- bootES(condition, data.col=dataCol, group.col = "Elicitation", contrast=groups, R = 5000)
  labelText         <- sprintf("%s-%s", label_lookup$label[label_lookup$group==groups[2]], label_lookup$label[label_lookup$group==groups[1]]) 
...
plotAllCI_fixedBreaks <- function(results, plotRange = c(-1, 1), breaks) {
  ...
  color_palette <- c('low' = '#b3e2cd', 'medium' = '#fdcdac', 'high' = '#cbd5e8')
...
plotMeanAccuracyBoxplots <- function(results, plotRange = c(-0.2, 0.2), breaks) {
  ...
  # Specify rendered box plot order to overwrite the default alphabetical order
  results$Elicitation <- factor(results$Elicitation, levels=c("ASF", "RF", "OD"))
  # Set up plot
